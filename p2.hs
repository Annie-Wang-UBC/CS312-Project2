...
functions ('-':' ':num ) todos =
    case delete (read num) todos of
        Nothing -> do
            putStrLn "No TODO entry matches that number!"
            prompt todos
...
year = month January   Sunday       31 ++ month February  Wednesday    28
    ++ month March     Wednesday    31 ++ month April     Saturday     30
    ++ month May       Monday       31 ++ month June      Thursday     30
    ++ month July      Saturday     31 ++ month August    Tuesday      31
    ++ month September Friday       30 ++ month October   Sunday       31
    ++ month November  Wednesday    30 ++ month December  Friday       31
